...
Customize Bricolage UI components to match your brand and design system.

## Theme Integration

Bricolage UI components automatically adapt to your app's theme defined in `MaterialApp`:
...
Use the **[Bricolage UI Playground](https://bricolage-ui.vercel.app)** to:
