...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Playground', link: 'https://bricolage-ui.vercel.app' }
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/TejasS1233/bricolage-ui' }
    ],

    footer: {
      copyright: 'Copyright © 2026 Bricolage UI | Created by Tejas S'
    },
  ...
  head: [
    ...
    ['meta', { name: 'og:title', content: 'Bricolage UI' }],
